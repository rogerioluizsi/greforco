		...
		<div id="list-contact" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="subject" title="${message(code: 'contact.subject.label', default: 'Subject')}" />
				...
				<g:each in="${contactInstanceList}" status="i" var="contactInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${contactInstance.id}">${fieldValue(bean: contactInstance, field: "dateCreated")}</g:link></td>
						...
						<td>${fieldValue(bean: contactInstance, field: "subject")}</td>
