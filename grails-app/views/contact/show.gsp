...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'contact.label', default: 'Menssagem')}" />
		<title>Mensagem Eviada</title>
	</head>
	<body>
		...
		<div id="show-contact" class="content scaffold-show" role="main">
			...
			<ol class="property-list contact">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="contact.name.label" default="Nome" /></span>
				...
				<li class="fieldcontain">
					<span id="email-label" class="property-label"><g:message code="contact.email.label" default="E-mail" /></span>
				...
				<g:if test="${contactInstance?.subject}">
				<li class="fieldcontain">
					<span id="subject-label" class="property-label"><g:message code="contact.subject.label" default="Assunto" /></span>
					
						<span class="property-value" aria-labelledby="subject-label"><g:fieldValue bean="${contactInstance}" field="subject"/></span>
				...
				<li class="fieldcontain">
					<span id="message-label" class="property-label"><g:message code="contact.message.label" default="Messagem" /></span>
				...
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="contact.dateCreated.label" default="Data de Envio" /></span>
			...
			<a class="btn btn-default" data-method="get" href="${createLink(uri: '/')}">Voltar</a>
		</div>
	</body>
</html>
