...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'teacher.label', default: 'Professor')}" />
		...
		<div id="show-teacher" class="content scaffold-show" role="main">
			...
			<ol class="property-list teacher">
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="teacher.user.label" default="E-mail" /></span>
				...
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="teacher.dateCreated.label" default="Data de Criação" /></span>
				...
				<li class="fieldcontain">
					<span id="formation-label" class="property-label"><g:message code="teacher.formation.label" default="Formação" /></span>
				...
				<li class="fieldcontain">
					<span id="university-label" class="property-label"><g:message code="teacher.university.label" default="Universidade" /></span>
